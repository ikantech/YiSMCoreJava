...
/**
 * Created by ikantech on 19-11-12.
 */
public class SM2SignTest {
    ...
    private String[] defaultUserIDSignDatas = new String[] {
            ...
            "5B6BFDDFC97AC8C5511529EA362B8D4A2EE29B6246DED7EE5B4E86B9886EE14D7FD2249CEA14219A10E440D0A11DC80C30FF91BE9A0886FDDFBA7C86EF7A35E8"
    };
    private String[] customUserIDSignDatas = new String[] {
            ...
            "20296874A4E81FEF0666143818861291480A7D7D54607E0E84B90162D6E1B2B755256D260709DEDF6C9FA4261BEB96669FDD702807A1DB4B86ECBE3F599CC943"
    };
...
//            cryptoKey.setupSM2PrivateKey(YiCrypto.fromHexString(sm2PrivK));
            ...
            for (byte[] userId: userIds) {
                ...
                for (String alg: algs) {
                    byte[] signBytes = YiSMCore.getInstance(alg)
                            .setupForSigner(true, cryptoKey)
                            .update(plainBytes, 0, plainBytes.length)
                            .generateSignature();

                    System.out.println(alg + ", " + YiSMCore.toHexString(signBytes));

                    boolean verified = YiSMCore.getInstance(alg)
                            .setupForSigner(false, cryptoKey)
                            .update(plainBytes, 0, plainBytes.length)
            ...
            cryptoKey.setupSM2PrivateKey(YiSMCore.fromHexString(sm2PrivK));
