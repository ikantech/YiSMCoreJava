...
public class SM2CipherTest {
    ...
    public void testGenKey() {
        try {
            ...
            System.out.println("private key: " + YiSMCore.toHexString(privK));
            System.out.println("public key: " + YiSMCore.toHexString(pubK));
            System.out.println("compressed public key: " + YiSMCore.toHexString(compressedPubK));
        }catch (Exception ex) {
    ...
    public void testCipher() {
        try {
            ...
            for (int i = 0; i < cipherAlgs.length; i++) {
                ...
                System.out.println(YiSMCore.toHexString(cipherBytes1));
